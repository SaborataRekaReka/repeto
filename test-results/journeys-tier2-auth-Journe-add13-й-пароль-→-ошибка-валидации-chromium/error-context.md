...
- Name: journeys-tier2-auth.spec.ts >> Journey 54: Auth edge cases — забыли пароль, дубли, валидация >> 54.5 Регистрация — короткий пароль → ошибка валидации
- Location: e2e\journeys-tier2-auth.spec.ts:83:7
