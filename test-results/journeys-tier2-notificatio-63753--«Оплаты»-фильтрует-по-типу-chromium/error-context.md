...
- Name: journeys-tier2-notifications.spec.ts >> Journey 34: Уведомления — табы, mark read, badge >> 34.5 Таб «Оплаты» фильтрует по типу
- Location: e2e\journeys-tier2-notifications.spec.ts:80:7
...
Call log:
  - waiting for getByRole('button', { name: 'Оплаты' })
        ...
        - generic [ref=e125] [cursor=pointer]:
          ...
          - generic [ref=e130]:
            ...
            - link "К ученику" [ref=e137]:
              - /url: /students/e5c3628d-7bf3-40ea-a0de-fafd90160e91
              - img [ref=e138]:
                - img [ref=e139]
              - text: К ученику
