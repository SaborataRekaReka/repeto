...
- Name: journeys-tier2-finance.spec.ts >> Journey 44: Финансовый обзор — виджеты и навигация >> 44.2 StatCard «Доход за месяц» содержит сумму в ₽
- Location: e2e\journeys-tier2-finance.spec.ts:86:7
...
Locator: locator('a[href="/finance/payments"]').filter({ hasText: 'Доход за месяц' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/finance/payments"]').filter({ hasText: 'Доход за месяц' })
