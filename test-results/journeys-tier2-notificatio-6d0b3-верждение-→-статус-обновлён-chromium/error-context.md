...
- Name: journeys-tier2-notifications.spec.ts >> Journey 35: Подтверждение и отклонение бронирования >> 35.3 Подтверждение → статус обновлён
- Location: e2e\journeys-tier2-notifications.spec.ts:216:7
