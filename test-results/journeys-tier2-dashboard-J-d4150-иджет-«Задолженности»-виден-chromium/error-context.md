...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 31: DebtList — задолженности и навигация >> 31.1 Виджет «Задолженности» виден
- Location: e2e\journeys-tier2-dashboard.spec.ts:220:7
...
Locator: locator('.card').filter({ hasText: 'Задолженности' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.card').filter({ hasText: 'Задолженности' })
