...
- Name: journeys-tier2-finance.spec.ts >> Journey 46: Пакеты — CRUD и фильтры >> 46.6 Таб «Завершённые» — пусто
- Location: e2e\journeys-tier2-finance.spec.ts:305:7
...
Call log:
  - waiting for getByRole('button', { name: 'Завершённые' })
