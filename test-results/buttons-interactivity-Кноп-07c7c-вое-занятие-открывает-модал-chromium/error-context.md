...
- Name: buttons-interactivity.spec.ts >> Кнопки — все интерактивные элементы работают >> Schedule: кнопка "Новое занятие" открывает модал
- Location: e2e\buttons-interactivity.spec.ts:22:7
...
Locator: getByRole('button', { name: /Новое занятие/i }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByRole('button', { name: /Новое занятие/i }).first()
