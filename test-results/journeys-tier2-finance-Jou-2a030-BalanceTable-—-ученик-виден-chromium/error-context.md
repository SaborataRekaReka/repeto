...
- Name: journeys-tier2-finance.spec.ts >> Journey 44: Финансовый обзор — виджеты и навигация >> 44.8 BalanceTable — ученик виден
- Location: e2e\journeys-tier2-finance.spec.ts:122:7
...
Locator: locator('.card').filter({ hasText: 'Баланс учеников' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.card').filter({ hasText: 'Баланс учеников' })
