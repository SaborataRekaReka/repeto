...
- Name: journeys-tier2-schedule.spec.ts >> Journey 25: Навигация стрелками >> 25.1 Месяц: заголовок показывает текущий месяц
- Location: e2e\journeys-tier2-schedule.spec.ts:115:7
...
Locator: locator('.text-h6').first()
Expected substring: "Апрель"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.text-h6').first()
  ...
  - generic [ref=e2]:
    - complementary [ref=e3]:
      ...
      - generic [ref=e50]:
        ...
        - button "НТ Навигация Тест" [ref=e69] [cursor=pointer]:
          - generic [ref=e70]: НТ
          - generic [ref=e71]: Навигация Тест
