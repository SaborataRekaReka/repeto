...
- Name: journeys-tier2-ui.spec.ts >> Journey 52: Тёмная тема >> 52.1 Переключение на тёмную тему
- Location: e2e\journeys-tier2-ui.spec.ts:196:7
...
Call log:
  - waiting for locator('div.relative.flex.w-14').locator('button').last()
