...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 31: DebtList — задолженности и навигация >> 31.4 Клик по должнику → страница ученика
- Location: e2e\journeys-tier2-dashboard.spec.ts:236:7
...
Call log:
  - waiting for locator('.card').filter({ hasText: 'Задолженности' }).locator('a[href="/students/3b8b3261-48d9-4308-a1d4-532a6071df89"]').first()
