...
- Name: journeys-tier2-settings.spec.ts >> Journey 38: Настройки — рендеринг всех вкладок >> 38.1 Безопасность — форма смены пароля видна
- Location: e2e\journeys-tier2-settings.spec.ts:85:7
...
Locator: locator('.card-title').filter({ hasText: 'Сменить пароль' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.card-title').filter({ hasText: 'Сменить пароль' })
      ...
      - generic [ref=e106]:
        - generic [ref=e107]:
          - generic [ref=e108]:
            ...
            - generic [ref=e112]: pw-1775929550441-2iqz9@test.com
          ...
          - generic [ref=e116]:
            - button "Аккаунт" [ref=e117] [cursor=pointer]:
              - img [ref=e118]:
                - img [ref=e119]
              - text: Аккаунт
            - button "Безопасность" [active] [ref=e121] [cursor=pointer]:
              - img [ref=e122]:
                - img [ref=e123]
              - text: Безопасность
        ...
        - generic [ref=e164]:
          - generic [ref=e165]:
            - generic [ref=e166]: Сменить пароль
            - generic [ref=e167]:
              - generic [ref=e168]:
                - generic [ref=e169]:
                  - generic [ref=e170]: Текущий пароль
                  - textbox "Введите текущий пароль" [ref=e173]
                - generic [ref=e174]:
                  - generic [ref=e175]: Новый пароль
                  - textbox "Введите новый пароль" [ref=e178]
                - generic [ref=e179]:
                  - generic [ref=e180]: Подтверждение пароля
                  - textbox "Повторите новый пароль" [ref=e183]
              - button "Сменить пароль" [ref=e185] [cursor=pointer]:
                - generic [ref=e186]: Сменить пароль
          - generic [ref=e187]:
            - generic [ref=e188]: Опасная зона
            - generic [ref=e190]:
              - generic [ref=e191]:
                - generic [ref=e192]: Удалить аккаунт
                - generic [ref=e193]: Все данные будут удалены без возможности восстановления
              - button "Удалить аккаунт" [ref=e194] [cursor=pointer]:
                - generic [ref=e195]: Удалить аккаунт
  - alert [ref=e196]
```
