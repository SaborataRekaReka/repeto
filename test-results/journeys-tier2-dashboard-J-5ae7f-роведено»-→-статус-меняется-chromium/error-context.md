...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 30: TodaySchedule — виджет и LessonDetailModal >> 30.5 Кнопка «Проведено» → статус меняется
- Location: e2e\journeys-tier2-dashboard.spec.ts:159:7
...
Locator: getByRole('button', { name: /Проведено/i })
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Проведено/i })
