...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 29: StatCards — числа и навигация >> 29.1 Активных учеников > 0
- Location: e2e\journeys-tier2-dashboard.spec.ts:62:7
...
Locator: locator('a.card[href="/students"]').locator('.text-h4')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.card[href="/students"]').locator('.text-h4')
