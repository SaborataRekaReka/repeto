...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 29: StatCards — числа и навигация >> 29.3 Доход за месяц содержит ₽
- Location: e2e\journeys-tier2-dashboard.spec.ts:79:7
...
Locator: locator('a.card[href="/finance"]').locator('.text-h4')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.card[href="/finance"]').locator('.text-h4')
