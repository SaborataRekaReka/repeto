...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 29: StatCards — числа и навигация >> 29.5 Клик по карточке «Ученики» → /students
- Location: e2e\journeys-tier2-dashboard.spec.ts:93:7
...
Call log:
  - waiting for locator('a.card[href="/students"]')
