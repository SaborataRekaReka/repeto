...
- Name: journeys-tier2-finance.spec.ts >> Journey 44: Финансовый обзор — виджеты и навигация >> 44.1 Страница обзора загружена — заголовок «Финансы»
- Location: e2e\journeys-tier2-finance.spec.ts:82:7
...
Locator: locator('.text-h3, .text-h4').filter({ hasText: 'Финансы' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.text-h3, .text-h4').filter({ hasText: 'Финансы' }).first()
