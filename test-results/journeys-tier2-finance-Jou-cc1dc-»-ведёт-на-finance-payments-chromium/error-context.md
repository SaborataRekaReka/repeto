...
- Name: journeys-tier2-finance.spec.ts >> Journey 44: Финансовый обзор — виджеты и навигация >> 44.9 BalanceTable — кнопка «Все оплаты» ведёт на /finance/payments
- Location: e2e\journeys-tier2-finance.spec.ts:128:7
...
Locator: locator('a[href="/finance/payments"]').filter({ hasText: 'Все оплаты' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/finance/payments"]').filter({ hasText: 'Все оплаты' })
