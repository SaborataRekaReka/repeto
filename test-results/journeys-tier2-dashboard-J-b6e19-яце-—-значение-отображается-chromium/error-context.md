...
- Name: journeys-tier2-dashboard.spec.ts >> Journey 29: StatCards — числа и навигация >> 29.2 Занятий в этом месяце — значение отображается
- Location: e2e\journeys-tier2-dashboard.spec.ts:71:7
...
Locator: locator('a.card[href="/schedule"]').locator('.text-h4')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.card[href="/schedule"]').locator('.text-h4')
