...
- Name: journeys-tier2-finance.spec.ts >> Journey 45: Оплаты — таблица, фильтры, детали >> 45.2 Таб «Все» активен по умолчанию
- Location: e2e\journeys-tier2-finance.spec.ts:191:7
