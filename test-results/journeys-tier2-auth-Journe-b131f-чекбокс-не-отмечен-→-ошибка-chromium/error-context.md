...
- Name: journeys-tier2-auth.spec.ts >> Journey 54: Auth edge cases — забыли пароль, дубли, валидация >> 54.6 Регистрация — чекбокс не отмечен → ошибка
- Location: e2e\journeys-tier2-auth.spec.ts:100:7
