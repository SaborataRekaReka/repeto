...
- Name: journeys-tier2-finance.spec.ts >> Journey 44: Финансовый обзор — виджеты и навигация >> 44.10 BalanceTable — клик по строке ученика → /students/
- Location: e2e\journeys-tier2-finance.spec.ts:135:7
...
Call log:
  - waiting for locator('.card').filter({ hasText: 'Баланс учеников' }).locator('tr').filter({ hasText: 'Фин Ученик' })
