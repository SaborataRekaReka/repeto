...
- Name: journeys-tier2-auth.spec.ts >> Journey 54: Auth edge cases — забыли пароль, дубли, валидация >> 54.3 Неверный логин → ошибка «Неверный email или пароль»
- Location: e2e\journeys-tier2-auth.spec.ts:57:7
