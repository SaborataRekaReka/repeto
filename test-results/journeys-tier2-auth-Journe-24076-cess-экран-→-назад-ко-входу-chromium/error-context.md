...
- Name: journeys-tier2-auth.spec.ts >> Journey 54: Auth edge cases — забыли пароль, дубли, валидация >> 54.1 «Забыли пароль» — форма → success-экран → назад ко входу
- Location: e2e\journeys-tier2-auth.spec.ts:7:7
