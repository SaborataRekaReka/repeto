...
- Name: journeys-tier2-ui.spec.ts >> Journey 50: Header — поиск, создать, уведомления >> 50.3 Меню «Создать» → «Новый ученик» → /students?create=1
- Location: e2e\journeys-tier2-ui.spec.ts:83:7
