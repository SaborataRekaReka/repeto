...
- Name: journeys-tier2-finance.spec.ts >> Journey 46: Пакеты — CRUD и фильтры >> 46.5 Таб «Активные» — пакет виден
- Location: e2e\journeys-tier2-finance.spec.ts:300:7
...
Call log:
  - waiting for getByRole('button', { name: 'Активные' })
