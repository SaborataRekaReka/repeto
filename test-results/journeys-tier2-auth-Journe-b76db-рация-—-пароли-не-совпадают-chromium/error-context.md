...
- Name: journeys-tier2-auth.spec.ts >> Journey 54: Auth edge cases — забыли пароль, дубли, валидация >> 54.4 Регистрация — пароли не совпадают
- Location: e2e\journeys-tier2-auth.spec.ts:66:7
