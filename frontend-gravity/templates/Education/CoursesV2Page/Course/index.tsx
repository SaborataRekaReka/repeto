...
const Course = ({ item }: CourseProps) => (
    ...
    >
        ...
        <div className="flex flex-col grow px-5 pb-5">
            <div className="relative flex justify-center items-center z-1 w-13 h-13 -mt-6.5 mb-4 rounded border border-n-1 bg-white text-0 dark:bg-n-1 dark:border-white">
