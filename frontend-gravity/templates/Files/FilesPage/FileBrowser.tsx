                        ...
                        {activeCloud && (
                            <div
                                style={{
                                    ...
                                    background: "linear-gradient(135deg, color-mix(in srgb, var(--accent) 22%, transparent) 0%, color-mix(in srgb, var(--accent) 18%, transparent) 55%, color-mix(in srgb, var(--accent) 14%, transparent) 100%)",
                                    boxShadow: "0 6px 18px color-mix(in srgb, var(--accent) 22%, transparent)",
                                    display: "flex",
                                    alignItems: "center",
