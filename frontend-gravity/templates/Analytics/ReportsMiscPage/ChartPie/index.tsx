...
const data = [
    { name: "Lavender", color: "#C6A6FF", value: 400 },
    { name: "Purple", color: "#AE7AFF", value: 300 },
    { name: "Green", color: "#98E9AB", value: 300 },
    { name: "Rose", color: "#D16B8F", value: 200 },
    { name: "Deep Purple", color: "#7030D9", value: 100 },
];

const COLORS = ["#C6A6FF", "#AE7AFF", "#98E9AB", "#D16B8F", "#7030D9"];
