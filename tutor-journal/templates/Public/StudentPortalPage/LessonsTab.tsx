                    ...
                    {activeLessons.map((lesson) => (
                        ...
                        >
                            ...
                            {lesson.status === "reschedule_pending" &&
                                lesson.rescheduleTo && (
                                    <div className="mb-3 p-3 rounded-sm bg-yellow-2 dark:bg-yellow-1/10">
                                                    ...
                                                    {[1, 2, 3, 4, 5].map((star) => (
                                                        <button
                                                            ...
                                                            className={`w-5 h-5 rounded-full transition-colors ${
                                                                star <= (l.rating || 0)
                                                                    ? "bg-yellow-1"
                                                                    : "bg-n-4 dark:bg-white/10 hover:bg-yellow-1/50"
                            ...
                            {[1, 2, 3, 4, 5].map((star) => (
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-full border-2 text-sm font-bold transition-colors ${
                                        star <= feedbackRating
                                            ? "bg-yellow-1 border-yellow-1 text-n-1"
                                            : "border-n-1 dark:border-white hover:border-yellow-1"
                                    }`}
